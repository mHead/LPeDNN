...
//	LPC_TIM0->MR2 = TimerInterval*3;
//	LPC_TIM0->MR3 = TimerInterval*4;
...
//  LPC_TIM0->PR = 20;
	...
	return (1);
		...
		if ( timer_num == 1 )
			{
			LPC_TIM1->MR0 = TimerInterval; //0.5 sec
			LPC_TIM1->MR1 = TimerInterval*2; //1 sec
			//LPC_TIM1->MR2 = TimerInterval*5;
			//LPC_TIM1->MR3 = TimerInterval*10;
...
//				LPC_TIM2->MR2 = TimerInterval*4;
//				LPC_TIM2->MR3 = TimerInterval*8;
...
//					LPC_TIM3->MR1 = TimerInterval*2; 
//					LPC_TIM3->MR2 = TimerInterval*3;
//					LPC_TIM3->MR3 = TimerInterval*4;
...
//*** <<< end of configuration section >>>    ***					
				...
				//  LPC_TIM3->PR = 20;
					...
					NVIC_SetPriority(TIMER3_IRQn, 4);	/* less priority than buttons and timer0 and timer 1 and timer 2*/
					return (1);
					}
				}
			}
